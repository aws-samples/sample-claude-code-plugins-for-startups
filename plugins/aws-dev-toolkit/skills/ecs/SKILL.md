...
5. Use the `awsknowledge` MCP tools (`mcp__awsknowledge__aws___search_documentation`, `mcp__awsknowledge__aws___read_documentation`, `mcp__awsknowledge__aws___recommend`) to verify current ECS limits, pricing, or feature availability
...
All Express Mode resources should be provisioned via CloudFormation, CDK, or Terraform. Use the `awsknowledge` MCP tools (`mcp__awsknowledge__aws___search_documentation`, `mcp__awsknowledge__aws___read_documentation`, `mcp__awsknowledge__aws___recommend`) or consult **`references/express-mode.md`** for API parameters and IaC examples.
