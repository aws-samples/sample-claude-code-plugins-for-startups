...
tools: Read, Grep, Glob, Bash(aws *), Bash(python3 *), Bash(pip *), Bash(docker *), mcp__awsknowledge__aws___search_documentation, mcp__awsknowledge__aws___read_documentation, mcp__awsknowledge__aws___recommend
model: opus
color: magenta
---
